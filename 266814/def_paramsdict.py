ALL = 0 # 1 for Fig 4C6
def get_params(CONTOG=1):
    """
    CONTOG=1 : conventinal dopamine cell
    CONTOG=0 : atypical dopamine cell
    """
    p_init = dict({})
    ...
    p_init['size'] =15*(1+1*CONTOG) # conventional size lowered a bit so that failure remains at 100 pA ramp
