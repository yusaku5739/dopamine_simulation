...
#define nrn_init _nrn_init__nabalan
#define _nrn_initial _nrn_initial__nabalan
#define nrn_cur _nrn_cur__nabalan
#define _nrn_current _nrn_current__nabalan
#define nrn_jacob _nrn_jacob__nabalan
#define nrn_state _nrn_state__nabalan
#define _net_receive _net_receive__nabalan 
#define state state__nabalan 
...
#define dt _nt->_dt
#define nainit _p[0]
#define nainit_columnindex 0
#define f _p[1]
#define f_columnindex 1
#define ina _p[2]
#define ina_columnindex 2
#define nai _p[3]
#define nai_columnindex 3
#define Dnai _p[4]
#define Dnai_columnindex 4
#define v _p[5]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "diam");
 	...
 	ivoc_help("help ?1 nabalan /home/workspace/266814/nabalan.mod\n");
...
static int _reset;
static char *modelname = "Sodium ion accumulation without diffusion";
...
_MATELM1(0, 0) *= ( PI * diam * diam / 4.0);  }
 ...
 f_flux = b_flux = 0.;
 _RHS1( 0) += (b_flux =   ( - f * ina * PI * diam * ( 1e4 ) / ( FARADAY ) ) );
 /*FLUX*/
    } return _reset;
 }
 ...
 */
 /* ~ nai < < ( - f * ina * PI * diam * ( 1e4 ) / ( FARADAY ) )*/
 f_flux = b_flux = 0.;
 Dnai += (b_flux =   ( - f * ina * PI * diam * ( 1e4 ) / ( FARADAY ) ) );
 /*FLUX*/
...
static void _initlists(){
 ...
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = nai_columnindex;  _dlist1[0] = Dnai_columnindex;
_first = 0;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/workspace/266814/nabalan.mod";
static const char* nmodl_file_text = 
