...
#define nrn_init _nrn_init__DopamineRelease
#define _nrn_initial _nrn_initial__DopamineRelease
#define nrn_cur _nrn_cur__DopamineRelease
#define _nrn_current _nrn_current__DopamineRelease
#define nrn_jacob _nrn_jacob__DopamineRelease
#define nrn_state _nrn_state__DopamineRelease
#define _net_receive _net_receive__DopamineRelease 
#define state state__DopamineRelease 
...
#define dt _nt->_dt
#define DA_max _p[0]
#define DA_max_columnindex 0
#define Vmax _p[1]
#define Vmax_columnindex 1
#define Km _p[2]
#define Km_columnindex 2
#define release_trigger _p[3]
#define release_trigger_columnindex 3
#define DA _p[4]
#define DA_columnindex 4
#define DDA _p[5]
#define DDA_columnindex 5
#define v _p[6]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 DopamineRelease /home/workspace/266814/dopamine_release.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Dopamine release and uptake mechanism";
...
/*CVODE*/
 ...
 DDA = DDA  / (1. - dt*( (( - Vmax * ( DA  + .001) / ( Km + ( DA  + .001) ) ) - ( - Vmax * DA / ( Km + DA )  )) / .001 )) ;
  return 0;
}
 /*END CVODE*/
...
{  double* _p; Datum* _ppvar; Datum* _thread; NrnThread* _nt;
 ...
 _tsav = t; {
   if ( _lflag  == 0.0 ) {
    ...
    int __i, __neq = 1;
    double __state = DA;
    double __primary_delta = (DA + DA_max) - __state;
    double __dtsav = dt;
...
static void _initlists(){
 ...
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = DA_columnindex;  _dlist1[0] = DDA_columnindex;
 _slist2[0] = DA_columnindex;
_first = 0;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/workspace/266814/dopamine_release.mod";
static const char* nmodl_file_text = 
