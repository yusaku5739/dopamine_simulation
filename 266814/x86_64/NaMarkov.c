...
#define nrn_init _nrn_init__NaMark
#define _nrn_initial _nrn_initial__NaMark
#define nrn_cur _nrn_cur__NaMark
#define _nrn_current _nrn_current__NaMark
#define nrn_jacob _nrn_jacob__NaMark
#define nrn_state _nrn_state__NaMark
#define _net_receive _net_receive__NaMark 
#define kin kin__NaMark 
#define rates rates__NaMark 
...
#define dist _p[2]
#define dist_columnindex 2
#define scale _p[3]
#define scale_columnindex 3
#define hshift _p[4]
#define hshift_columnindex 4
#define oinit _p[5]
#define oinit_columnindex 5
#define DISABLE _p[6]
#define DISABLE_columnindex 6
#define BALBI _p[7]
#define BALBI_columnindex 7
#define ina _p[8]
#define ina_columnindex 8
#define gna _p[9]
#define gna_columnindex 9
#define c1c2 _p[10]
#define c1c2_columnindex 10
#define c2c1 _p[11]
#define c2c1_columnindex 11
#define o1c2 _p[12]
#define o1c2_columnindex 12
#define c2o1 _p[13]
#define c2o1_columnindex 13
#define c1 _p[14]
#define c1_columnindex 14
#define c2 _p[15]
#define c2_columnindex 15
#define i1 _p[16]
#define i1_columnindex 16
#define i2 _p[17]
#define i2_columnindex 17
#define o1 _p[18]
#define o1_columnindex 18
#define i1c1 _p[19]
#define i1c1_columnindex 19
#define c1i1 _p[20]
#define c1i1_columnindex 20
#define i2i1 _p[21]
#define i2i1_columnindex 21
#define i1i2 _p[22]
#define i1i2_columnindex 22
#define o1i1 _p[23]
#define o1i1_columnindex 23
#define i1o1 _p[24]
#define i1o1_columnindex 24
#define c2i1 _p[25]
#define c2i1_columnindex 25
#define i1c2 _p[26]
#define i1c2_columnindex 26
#define Dc1 _p[27]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_NaMark", _hoc_setdata,
 "DoubSig_NaMark", _hoc_DoubSig,
 "boltz_NaMark", _hoc_boltz,
 "rates_NaMark", _hoc_rates,
 0, 0
};
#define DoubSig DoubSig_NaMark
#define boltz boltz_NaMark
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 NaMark /home/workspace/266814/NaMarkov.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Markov sodium channel of NaV 1.6 ";
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
 ...
 _lvm = _lv + shift ;
   if ( BALBI < 1.0 + 1e-6  && BALBI > 1.0 - 1e-6 ) {
     ...
     i1i2 = dist * scale * DoubSig ( _threadargscomma_ _lvm , 0.0 , 0.0 , 0.0 , 2.2e-3 , - 90.0 , - 5.0 ) ;
     i2i1 = scale * DoubSig ( _threadargscomma_ _lvm , 1.7e-2 , - 90.0 , 15.0 , 0.0 , 0.0 , 0.0 ) ;
     }
   else {
     ...
     c2i1 = 0.3 * c1i1 ;
     i1c2 = 0.0 ;
     i1i2 = 2.0 * dist * DoubSig ( _threadargscomma_ _lvm , 0.0 , 0.0 , 0.0 , 2.0e-2 , - 25.0 , - 5.0 ) ;
     i2i1 = 2.0 * DoubSig ( _threadargscomma_ _lvm , 1.8e-3 , - 50.0 , 10.0 , 0.0 , 0.0 , 0.0 ) ;
     }
    return 0; }
...
static void _initlists(){
 ...
 _slist1[4] = o1_columnindex;  _dlist1[4] = Do1_columnindex;
_first = 0;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/workspace/266814/NaMarkov.mod";
static const char* nmodl_file_text = 
